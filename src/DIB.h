...
public:
	...
	void    Erasion(HANDLE hDIB,int m_top,int m_bottom,int m_left,int m_right);
    ...
    BOOL      PaintDIBTrue1(HDC hDC,LPRECT lpDCRect,HANDLE hDIB,LPRECT lpDIBRect ,DWORD dwRop);
...
public :
	...
	void Dilation(HANDLE hDIB,int m_top,int m_bottom,int m_left,int m_right);
