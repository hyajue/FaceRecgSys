...
//////////////////////////////////////////////////////////////////////
//constructor£º
//parameters£º    source- source img
//          width£­ img width
//          height£­img height
//////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
//Calculate   Cb£¬Cr values
///////////////////////////////////////////////////////////////////////////////
TCbCr CLikelyHood::CalCbCr(int R, int G, int B)
{
	TCbCr res;
//	res.Cb =( 128 - 37.797 * R/255 - 74.203 *G/255 + 111.945 * B/255);
//	res.Cr =( 128 + 111.945 *R/255 - 93.786 * G/255 -18.214 * B/255);
	res.Cb = 128 - 0.148*(double)R - 0.291*(double)G + 0.439*(double)B;
	res.Cr = 128 + 0.439*(double)R - 0.368*(double)G -0.071*(double)B;
	return res;
}
...
bool CLikelyHood::CalBinary()
{
	...
	for(int k=5;k>=0;k--)
	{
		...
		for(j=0; j<m_nWidth; j++)
		{
			...
			{m_pBinaryArray[i][j] = 1;a++;}
			else
			{m_pBinaryArray[i][j] = 0;b++;}
